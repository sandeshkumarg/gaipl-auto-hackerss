...
import { jsonToLogicalString } from '../../utilities/helper';
import { Dialog, DialogContent, DialogTitle, IconButton, Tooltip } from '@mui/material';
import CloseIcon from '@mui/icons-material/Close';
import OpenInNewIcon from '@mui/icons-material/OpenInNew';

const AutomationChatbotWidget = (automationdata) => {
  ...
  const handleSend = async () => {
    ...
    try {
      const response = await fetch("http://localhost:8000/api/automationchat", {
        ...
        body: JSON.stringify({ chatid: chatID.current, messages: messagesForBackend, automationdata: jsonToLogicalString(automationdata) })
      });
