...
class MCPClient:
    def __init__(self):
        ...
        self.chatgoogle = ChatGoogleGenerativeAI(model="gemini-2.0-flash")
    ...
    async def process_query(self, query: str) -> str:
        ...
        superllm = llm.bind_tools(available_tools)

        response = superllm.invoke(messages)
        ...
        #response = self.chatgoogle.predict(
        #    model="chat-bison",
        #    messages=messages,
